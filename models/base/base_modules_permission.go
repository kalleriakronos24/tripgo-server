...
type BaseModulePermission struct {
	...
	// relations
	Module     *system.Module      `gorm:"constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;foreignKey:ModuleID;references:ID" json:"module"`
	Permission *system.Permissions `gorm:"constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;foreignKey:ModuleID;references:ID" json:"permission"`
