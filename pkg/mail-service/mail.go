...
func SendMailV3(p *TSendMail) (err error) {
	...
	dialer := gomail.NewDialer("live.smtp.mailtrap.io", 2525, "api", "eeb698e014595388ad1d80ed7e9ffb54")
	// dialer.tls
...
// 	dialer, err := mailer.NewClient("live.smtp.mailtrap.io", mailer.WithTLSPortPolicy(465), mailer.WithSMTPAuth(mailer.SMTPAuthPlain), mailer.WithUsername("api"), mailer.WithPassword("eeb698e014595388ad1d80ed7e9ffb54"))
